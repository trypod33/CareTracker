...
public final class MedicationDao_Impl implements MedicationDao {
  ...
  @Override
  public Object insertMedication(final MedicationEntity med,
    ...
    return CoroutinesRoom.execute(__db, true, new Callable<Long>() {
      ...
      public Long call() throws Exception {
        ...
        try {
          final Long _result = __insertionAdapterOfMedicationEntity.insertAndReturnId(med);
  ...
  @Override
  public Object deleteMedication(final MedicationEntity med,
    ...
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        __db.beginTransaction();
        try {
          __deletionAdapterOfMedicationEntity.handle(med);
          __db.setTransactionSuccessful();
  ...
  @Override
  public Object updateMedication(final MedicationEntity med,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        __db.beginTransaction();
        try {
          __updateAdapterOfMedicationEntity.handle(med);
          __db.setTransactionSuccessful();
          return Unit.INSTANCE;
        } finally {
          __db.endTransaction();
  ...
  public Flow<List<MedLogEntity>> getRecentLogs(final long medId) {
    final String _sql = "SELECT * FROM med_logs WHERE medicationId = ? ORDER BY takenAt DESC LIMIT 30";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, medId);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"med_logs"}, new Callable<List<MedLogEntity>>() {
